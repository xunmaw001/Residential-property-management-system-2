    ...
    */
    ...
    public R save(@RequestBody WeixiuEntity weixiu, HttpServletRequest request){
        ...
        if(false)
            ...
            weixiu.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));


            weixiu.setShifouchuliTypes(1);
...
//                            weixiuEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            weixiuEntity.setWeixiuName(data.get(0));                    //维修标题 要改的
//                            weixiuEntity.setWeixiuContent("");//照片
//                            weixiuEntity.setShifouchuliTypes(Integer.valueOf(data.get(0)));   //是否处理 要改的
    ...
    */
    ...
    public R add(@RequestBody WeixiuEntity weixiu, HttpServletRequest request){
        ...
        Wrapper<WeixiuEntity> queryWrapper = new EntityWrapper<WeixiuEntity>()
            ...
            .eq("shifouchuli_types", weixiu.getShifouchuliTypes())
            ;
