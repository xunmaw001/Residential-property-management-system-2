...
public class WeixiuView extends WeixiuEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 是否处理的值
		*/
		private String shifouchuliValue;
	...
	public WeixiuView(WeixiuEntity weixiuEntity) {
		try {
			...
			* 获取： 是否处理的值
			*/
			public String getShifouchuliValue() {
				return shifouchuliValue;
			}
			/**
			* 设置： 是否处理的值
			*/
			public void setShifouchuliValue(String shifouchuliValue) {
				this.shifouchuliValue = shifouchuliValue;
			}
