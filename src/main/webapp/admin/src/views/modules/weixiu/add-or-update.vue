    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修标题" prop="weixiuName">
                       <el-input v-model="ruleForm.weixiuName"
                                 placeholder="维修标题" clearable  :readonly="ro.weixiuName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="维修标题" prop="weixiuName">
                           <el-input v-model="ruleForm.weixiuName"
                                     placeholder="维修标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="维修内容" prop="weixiuContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.weixiuContent" label="维修内容" prop="weixiuContent">
                            <span v-html="ruleForm.weixiuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="sessionTable !='yonghu'">
                    <el-form-item class="select" v-if="type!='info'"  label="是否处理" prop="shifouchuliTypes">
                        <el-select v-model="ruleForm.shifouchuliTypes" :disabled="ro.shifouchuliTypes" placeholder="请选择是否处理">
                            <el-option
                                v-for="(item,index) in shifouchuliTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="是否处理" prop="shifouchuliValue">
                        <el-input v-model="ruleForm.shifouchuliValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   weixiuName: [
                              { required: true, message: '维修标题不能为空', trigger: 'blur' },
                          ],
                   weixiuContent: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shifouchuli_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shifouchuliTypesOptions = data.data.list;
                    }
                });
