    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴费金额" prop="jiaofeiPrice">
                       <el-input v-model="ruleForm.jiaofeiPrice"
                                 placeholder="缴费金额" clearable  :readonly="ro.jiaofeiPrice"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="缴费金额" prop="jiaofeiPrice">
                           <el-input v-model="ruleForm.jiaofeiPrice"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="缴费备注" prop="jiaofeiContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiaofeiContent" label="缴费备注" prop="jiaofeiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiaofeiContent: [
                              { required: true, message: '缴费备注不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
